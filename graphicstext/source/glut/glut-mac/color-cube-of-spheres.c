 ...
 * For example, on MacOS using XCode developer tools:
 *
 *     clang -DGL_SILENCE_DEPRECATION -o cubes color-cube-of-spheres.c camera.c -framework OpenGL -framework GLUT
 */
