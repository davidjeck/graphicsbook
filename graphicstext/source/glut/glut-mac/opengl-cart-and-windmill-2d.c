 ...
 * MacOS with XCode developer toold:
 *
 *       clang -DGL_SILENCE_DEPRECATION -o cart-and-windmill opengl-cart-and-windmill-2d.c -framework OpenGL -framework GLUT
 */
...
/*
 * Called when the windows opens or is resized.
 */
